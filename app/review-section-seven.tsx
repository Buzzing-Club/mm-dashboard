      ...
      <div className="review-seven-grid">
        {stage.metrics.map((metric) => {
          ...
          return <article className="review-seven-metric" key={metric.id}>
            ...
            <div className="review-seven-value"><strong>{sample?.value != null ? formatReviewNumber(sample.value) : sample ? "不可计算" : "待接入"}</strong><small>{sample ? metric.unit : "缺少阶段统计"}</small></div>
